	...
	<header>
		<div class="container">
			<div class="intro-text">
				<div class="intro-heading">Welcome! Good luck with your
					apartment search!</div>
				<div class="intro-lead-in">
					We provide you with all the different location in a city</br> so that
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="team-member">
						<img src="resources/img/team/1.jpg"
				...
				<div class="col-sm-4">
					<div class="team-member">
						<img src="resources/img/team/2.jpg"
							class="img-responsive img-circle" alt="">
						<h4>Larry Parker</h4>
				...
				<div class="col-sm-4">
					<div class="team-member">
						<img src="resources/img/team/3.jpg"
							class="img-responsive img-circle" alt="">
